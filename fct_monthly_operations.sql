        ...
        create or replace transient table MUSEUM_DW_PROD.GOLD.fct_monthly_operations
        copy grants as
        (WITH daily AS (
    SELECT
        ops.visit_date,
        ...
        ops._loaded_at
    FROM MUSEUM_DW_PROD.GOLD.fct_daily_operations ops
    LEFT JOIN MUSEUM_DW_PROD.GOLD.dim_date dd ON ops.visit_date = dd.date_day
)
