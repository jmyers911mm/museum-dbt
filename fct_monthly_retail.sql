        ...
        create or replace transient table MUSEUM_DW_PROD.GOLD.fct_monthly_retail
        copy grants as
        (WITH daily AS (
    SELECT
        rp.transaction_date,
        ...
        rp._loaded_at
    FROM MUSEUM_DW_PROD.GOLD.fct_retail_performance rp
    LEFT JOIN MUSEUM_DW_PROD.GOLD.dim_date dd ON rp.transaction_date = dd.date_day
)
