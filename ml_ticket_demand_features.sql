        ...
        create or replace transient table MUSEUM_DW_PROD.ML_FEATURES.ml_ticket_demand_features
         as
        (
...
with_features AS (
    ...
    FROM daily_demand d
    LEFT JOIN MUSEUM_DW_PROD.GOLD.dim_date dd ON d.entry_date = dd.date_day
)
